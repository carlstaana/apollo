...
public class WeightedGraphTests {
	...
	public void setup() {
		...
		value1 = "A";
		dwg.addNode(value1);
		node1 = (Node) dwg.getNodeList().getFirst();
		// add another node
		value1 = "B";
		dwg.addNode(value1);
		node2 = (Node) dwg.getNodeList().getFirst();
		// add another node
		value1 = "C";
		dwg.addNode(value1);
		node3 = (Node) dwg.getNodeList().getFirst();
		// add another node
		value1 = "D";
		dwg.addNode(value1);
		node4 = (Node) dwg.getNodeList().getFirst();
		// add another node
		value1 = "E";
		dwg.addNode(value1);
		node5 = (Node) dwg.getNodeList().getFirst();
		// add another node
		value1 = "F";
		dwg.addNode(value1);
		node6 = (Node) dwg.getNodeList().getFirst();
	...
	public void testConnectNodes() throws Exception {
		...
		edgeValue = 10;
		dwg.connect(node1, node2, edgeValue);
		Edge con1 = (Edge) dwg.getEdgeList().getFirst();
